...
func (base *ArchivePayload) UnmarshalJSON(b []byte) error {
	...
	case "DeletePayload":
		base.Value = new(DeletePayload)
	case "AttachmentArchivePayload":
		base.Value = new(AttachmentArchivePayload)
	case "CycleArchivePayload":
		base.Value = new(CycleArchivePayload)
	case "InitiativeArchivePayload":
		base.Value = new(InitiativeArchivePayload)
	case "IssueArchivePayload":
		base.Value = new(IssueArchivePayload)
	case "NotificationArchivePayload":
		base.Value = new(NotificationArchivePayload)
	case "ProjectArchivePayload":
		base.Value = new(ProjectArchivePayload)
	case "RoadmapArchivePayload":
		base.Value = new(RoadmapArchivePayload)
	case "TeamArchivePayload":
		base.Value = new(TeamArchivePayload)
	case "WorkflowStateArchivePayload":
		base.Value = new(WorkflowStateArchivePayload)
	case "":
		return nil
	default:
		return fmt.Errorf("gqlclient: interface ArchivePayload: unknown __typename %q", data.TypeName)
	}
...
func (base *Entity) UnmarshalJSON(b []byte) error {
	...
	switch data.TypeName {
	case "Notification":
		base.Value = new(Notification)
	case "NotificationSubscription":
		base.Value = new(NotificationSubscription)
	case "IssueNotification":
		base.Value = new(IssueNotification)
	case "ProjectNotification":
		base.Value = new(ProjectNotification)
	case "OauthClientApprovalNotification":
		base.Value = new(OauthClientApprovalNotification)
	case "CustomViewNotificationSubscription":
		base.Value = new(CustomViewNotificationSubscription)
	case "CycleNotificationSubscription":
		base.Value = new(CycleNotificationSubscription)
	case "LabelNotificationSubscription":
		base.Value = new(LabelNotificationSubscription)
	case "ProjectNotificationSubscription":
		base.Value = new(ProjectNotificationSubscription)
	case "TeamNotificationSubscription":
		base.Value = new(TeamNotificationSubscription)
	case "UserNotificationSubscription":
		base.Value = new(UserNotificationSubscription)
	case "":
		return nil
	default:
...
func (base *Node) UnmarshalJSON(b []byte) error {
	...
	switch data.TypeName {
	case "ApiKey":
		base.Value = new(ApiKey)
	case "User":
		base.Value = new(User)
	case "Attachment":
		base.Value = new(Attachment)
	case "AuditEntry":
		base.Value = new(AuditEntry)
	case "ProjectUpdate":
		base.Value = new(ProjectUpdate)
	case "Project":
	...
	case "Company":
		base.Value = new(Company)
	case "CustomView":
		base.Value = new(CustomView)
	case "Issue":
		base.Value = new(Issue)
	case "Cycle":
		base.Value = new(Cycle)
	case "Document":
		base.Value = new(Document)
	case "DocumentContentHistory":
		base.Value = new(DocumentContentHistory)
	case "DocumentContent":
		base.Value = new(DocumentContent)
	case "EmailIntakeAddress":
		base.Value = new(EmailIntakeAddress)
	case "Emoji":
		base.Value = new(Emoji)
	case "IntegrationTemplate":
		base.Value = new(IntegrationTemplate)
	case "Integration":
		base.Value = new(Integration)
	case "ExternalUser":
		base.Value = new(ExternalUser)
	case "Template":
		base.Value = new(Template)
	case "Organization":
		base.Value = new(Organization)
	case "InitiativeToProject":
		base.Value = new(InitiativeToProject)
	case "RoadmapToProject":
		base.Value = new(RoadmapToProject)
	case "Roadmap":
		base.Value = new(Roadmap)
	case "Initiative":
		base.Value = new(Initiative)
	case "Facet":
		base.Value = new(Facet)
	case "Favorite":
		base.Value = new(Favorite)
	case "GitAutomationTargetBranch":
		base.Value = new(GitAutomationTargetBranch)
	case "GitAutomationState":
		base.Value = new(GitAutomationState)
	case "IntegrationsSettings":
		base.Value = new(IntegrationsSettings)
	case "IssueLabel":
		base.Value = new(IssueLabel)
	case "IssueDraft":
		base.Value = new(IssueDraft)
	case "IssueHistory":
		base.Value = new(IssueHistory)
	case "IssueImport":
		base.Value = new(IssueImport)
	case "IssueRelation":
		base.Value = new(IssueRelation)
	case "OauthClientApproval":
		base.Value = new(OauthClientApproval)
	case "Entity":
		base.Value = new(Entity)
	case "OauthClient":
		base.Value = new(OauthClient)
	case "OrganizationDomain":
		base.Value = new(OrganizationDomain)
	case "OrganizationInvite":
		base.Value = new(OrganizationInvite)
	case "ProjectMilestone":
		base.Value = new(ProjectMilestone)
	case "ProjectLink":
		base.Value = new(ProjectLink)
	case "ProjectStatus":
		base.Value = new(ProjectStatus)
	case "ProjectUpdateInteraction":
		base.Value = new(ProjectUpdateInteraction)
	case "PushSubscription":
		base.Value = new(PushSubscription)
	case "PaidSubscription":
		base.Value = new(PaidSubscription)
	case "Team":
		base.Value = new(Team)
	case "TeamMembership":
		base.Value = new(TeamMembership)
	case "TimeSchedule":
		base.Value = new(TimeSchedule)
	case "TriageResponsibility":
		base.Value = new(TriageResponsibility)
	case "UserSettings":
		base.Value = new(UserSettings)
	case "ViewPreferences":
		base.Value = new(ViewPreferences)
	case "Webhook":
		base.Value = new(Webhook)
	case "WorkflowCronJobDefinition":
		base.Value = new(WorkflowCronJobDefinition)
	case "WorkflowDefinition":
		base.Value = new(WorkflowDefinition)
	case "WorkflowState":
		base.Value = new(WorkflowState)
	case "IssueSearchResult":
		base.Value = new(IssueSearchResult)
	case "DocumentSearchResult":
		base.Value = new(DocumentSearchResult)
	case "ProjectSearchResult":
		base.Value = new(ProjectSearchResult)
	case "Notification":
		base.Value = new(Notification)
	case "NotificationSubscription":
		base.Value = new(NotificationSubscription)
...
func (base *Notification) UnmarshalJSON(b []byte) error {
	...
	case "":
		return nil
	default:
		return fmt.Errorf("gqlclient: interface Notification: unknown __typename %q", data.TypeName)
	}
	return json.Unmarshal(b, base.Value)
}
...
func (base *NotificationSubscription) UnmarshalJSON(b []byte) error {
	type Raw NotificationSubscription
	var data struct {
		*Raw
		TypeName string `json:"__typename"`
	}
	...
	case "":
		return nil
	default:
		return fmt.Errorf("gqlclient: interface NotificationSubscription: unknown __typename %q", data.TypeName)
	}
	return json.Unmarshal(b, base.Value)
}
...
func (*NotificationSubscription) isEntity() {}

func (*NotificationSubscription) isNode() {}
...
func (base *OrganizationInviteDetailsPayload) UnmarshalJSON(b []byte) error {
	type Raw OrganizationInviteDetailsPayload
	var data struct {
		*Raw
		TypeName string `json:"__typename"`
	}
	...
	switch data.TypeName {
	case "OrganizationInviteFullDetailsPayload":
		base.Value = new(OrganizationInviteFullDetailsPayload)
	case "OrganizationAcceptedOrExpiredInviteDetailsPayload":
		base.Value = new(OrganizationAcceptedOrExpiredInviteDetailsPayload)
	case "":
		return fmt.Errorf("gqlclient: union OrganizationInviteDetailsPayload: missing __typename field")
	default:
		return fmt.Errorf("gqlclient: union OrganizationInviteDetailsPayload: unknown __typename %q", data.TypeName)
	}
	return json.Unmarshal(b, base.Value)
}
...
func FetchTeams(client *gqlclient.Client, ctx context.Context) (teams *TeamConnection, err error) {
	op := gqlclient.NewOperation("query fetchTeams {\n\tteams {\n\t\tnodes {\n\t\t\tid\n\t\t\tname\n\t\t}\n\t}\n}\n")
	var respData struct {
		Teams *TeamConnection
	}
	err = client.Execute(ctx, op, &respData)
	return respData.Teams, err
}

func FetchIssue(client *gqlclient.Client, ctx context.Context, id string) (issue *Issue, err error) {
	op := gqlclient.NewOperation("query fetchIssue ($id: String!) {\n\tissue(id: $id) {\n\t\tid\n\t\ttitle\n\t\tdescription\n\t}\n}\n")
	op.Var("id", id)
	var respData struct {
		Issue *Issue
	}
	err = client.Execute(ctx, op, &respData)
	return respData.Issue, err
}
...
func FetchIssues(client *gqlclient.Client, ctx context.Context, filter *IssueFilter, first *int32, after *string) (issues *IssueConnection, err error) {
	op := gqlclient.NewOperation("query fetchIssues ($filter: IssueFilter, $first: Int, $after: String) {\n\tissues(filter: $filter, first: $first, after: $after) {\n\t\tnodes {\n\t\t\tidentifier\n\t\t\tsortOrder\n\t\t\ttitle\n\t\t\tdescription\n\t\t\tbranchName\n\t\t\tcycle {\n\t\t\t\tid\n\t\t\t\tname\n\t\t\t}\n\t\t\tlabels {\n\t\t\t\tnodes {\n\t\t\t\t\tname\n\t\t\t\t\tcolor\n\t\t\t\t}\n\t\t\t}\n\t\t\tproject {\n\t\t\t\tname\n\t\t\t\tid\n\t\t\t\tcolor\n\t\t\t}\n\t\t\tassignee {\n\t\t\t\tname\n\t\t\t\tisMe\n\t\t\t}\n\t\t\tstate {\n\t\t\t\tname\n\t\t\t\tcolor\n\t\t\t\tposition\n\t\t\t\ttype\n\t\t\t}\n\t\t}\n\t\tpageInfo {\n\t\t\tendCursor\n\t\t\thasNextPage\n\t\t\thasPreviousPage\n\t\t\tstartCursor\n\t\t}\n\t}\n}\n")
